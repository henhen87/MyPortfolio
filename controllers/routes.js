...
var homeData = {
	...
	paragraphTwo: "I have three years of programming experience with C++, JavaScript (es5, es6, es7), Node, Express with RESTful API's, MongoDB, MySQL, React with Redux, HTML/Bootstrap, CSS, Webpack, Babel and much more. I consider myself to be very talented at solving algorithms, and when faced with a really challenging one, using resources available to me such as the internet and whiteboards never lets me down." + 
